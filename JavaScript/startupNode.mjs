...
await Promise.all([
    ...
    import('./overrides/_MethodDictionary.js'), import('./overrides/_MemorySourceFileArray.js'), import('./overrides/exceptions/_Object.js'), import('./overrides/processes/_Process.js'),
    import('./overrides/exceptions/_ProgressInitiationException.js'), import('./overrides/processes/_ProcessorScheduler.js'), import('./overrides/_ProtoObject.js'),
    import('./overrides/_Random.js'), import('./overrides/_RunArray.js'), import('./overrides/processes/_Semaphore.js'), import('./overrides/numbers/_SmallInteger.js'),
    import('./overrides/_SmalltalkImage.js'), import('./overrides/exceptions/_StandardToolSet.js'), import('./overrides/strings/_String.js'), import('./overrides/strings/_Symbol.js'),
    import('./overrides/testing/_TestCase.js'), import('./overrides/exceptions/_UnhandledError.js'), import('./overrides/exceptions/_UnhandledWarning.js'),
...
globalThis.memoryLogger = () => console.log(process.memoryUsage());
