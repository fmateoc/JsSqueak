...
Object.override(SmalltalkGlobals._ByteArray.prototype, {
    ...
    *_sort_(_aSortBlock) {
        ...
        if (size > 1) {
            ...
            if (func) {
                //We have to avoid interrupt checks, since we cannot yield inside non-generator native function sort
                GlobalActivationCounter = Number.MAX_SAFE_INTEGER;
                try {
                    this.bytes.sort(func);
                } finally {
